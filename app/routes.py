...
@app.route('/all_my_events',  methods=['GET', 'POST'])
@login_required
def all_my_events():
    events = Event.query.filter_by(author_email=current_user.email)
    return render_template('all_my_events.html', events=events)
